...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("eqxpmpfj")

  // remove
  collection.schema.removeField("kfywu0rz")

  // remove
  collection.schema.removeField("sjkzehyp")

  // remove
  collection.schema.removeField("bze8yemx")
