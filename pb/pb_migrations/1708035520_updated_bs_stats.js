...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("eez5lre4")

  // remove
  collection.schema.removeField("bndalee6")

  // remove
  collection.schema.removeField("muxlhz54")
