...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("zorigghu")

  // remove
  collection.schema.removeField("bnu0yqkp")

  // remove
  collection.schema.removeField("ynuijd9h")

  // remove
  collection.schema.removeField("qn4np7rm")

  // remove
  collection.schema.removeField("aoc8qwvt")
