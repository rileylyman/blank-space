...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("utdimo0l")

  // remove
  collection.schema.removeField("3tshr5yb")

  // remove
  collection.schema.removeField("y89xtmpr")

  // remove
  collection.schema.removeField("hq3mjzq2")

  // remove
  collection.schema.removeField("seehqwvm")
