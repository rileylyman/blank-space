...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("wl2mnnv1")

  // remove
  collection.schema.removeField("cmmbcdgz")

  // remove
  collection.schema.removeField("vcx58agj")

  // remove
  collection.schema.removeField("cpvxokxb")

  // remove
  collection.schema.removeField("eyfd02v0")
