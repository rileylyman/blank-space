...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("mxdlc76x")

  // remove
  collection.schema.removeField("hwlpaauc")

  // remove
  collection.schema.removeField("9lcm89t6")
