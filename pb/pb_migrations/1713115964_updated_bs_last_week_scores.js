...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("jih6cfio")

  // remove
  collection.schema.removeField("u2dkukh1")

  // remove
  collection.schema.removeField("ktbonfrv")

  // remove
  collection.schema.removeField("rjp6act5")

  // remove
  collection.schema.removeField("tvxoxjnn")
