...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ixmocsqc")

  // remove
  collection.schema.removeField("negdz0vf")

  // remove
  collection.schema.removeField("rto0sf1o")

  // remove
  collection.schema.removeField("gsnjs2is")

  // remove
  collection.schema.removeField("1fnwwraz")
  ...
  // remove
  collection.schema.removeField("y0e4svup")

  // remove
  collection.schema.removeField("qne0btd2")

  // remove
  collection.schema.removeField("wbxtjkgq")

  // remove
  collection.schema.removeField("d87udaxl")

  // remove
  collection.schema.removeField("zosmacvg")
